    ...
    <footer className="bg-dark text-light py-5">
      <Container>
        ...
        <p className="text-center text-muted">
          &copy; {new Date().getFullYear()} Star Wars, Inc.
        </p>
      </Container>
    </footer>
  );
